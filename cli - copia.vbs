...
Function OpenAccessCanonical(dbPath, password)
    ...
    If password <> "" Then
        LogVerbose "Contraseña proporcionada: Sí"
    Else
        LogVerbose "Contraseña proporcionada: No"
    End If
    ...
    LogVerbose "Intentando abrir base de datos con contraseña..."
    If password <> "" Then
    ...
    If Err.Number <> 0 Then
        LogMessage "ERROR: No se pudo abrir la base de datos: " & Err.Description & " (Código: " & Err.Number & ")"
        objApp.Quit
        Set objApp = Nothing
        Set OpenAccessCanonical = Nothing
        Exit Function
...
Sub Main()
    ...
    Select Case LCase(command)
        ...
        Case "schema"
            ...
            ' Usar contraseña global si se especificó --password en el comando schema
            If passwordOpt <> "" Then
                gPassword = passwordOpt
                LogMessage "Contraseña especificada por parámetro"
            End If
